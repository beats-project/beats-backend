...
//            detail = ProblemDetail.forStatusAndDetail(HttpStatusCode.valueOf(401), ex.getMessage());
        ...
        return new ResponseEntity<>(GenericResponse.error(new ResponseMessage("SERVER-ERROR","Internal server error"), HttpStatusCode.INTERNAL_SERVER_ERROR.getValue(),HttpStatusCode.INTERNAL_SERVER_ERROR.getDescription()), new HttpHeaders(), 500);
    }
