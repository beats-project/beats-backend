...
public enum ErrorCodes {
    ...
    EMAIL_REQUIRED("EMAIL_REQUIRED", "Required email value", 422, HttpStatusCode.UNPROCESSABLE_ENTITY.getDescription(),
    ...
    EMAIL_NOT_FOUND("EMAIL_NOT_FOUND", "User with email does not exist", 404, HttpStatusCode.NOT_FOUND.getDescription(),
    ...
    PASSWORD_INCORRECT("PASSWORD_INCORRECT", "Incorrect password", 401, HttpStatusCode.UNAUTHORIZED.getDescription(),
            HttpStatus.UNAUTHORIZED),
