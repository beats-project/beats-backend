...
public enum ErrorCodes {
    ...
    // Endpoint - /auth/login
    EMAIL_OR_PASSWORD_INCORRECT("EMAIL_OR_PASSWORD_INCORRECT", "Incorrect email or password", 401, HttpStatusCode.UNAUTHORIZED.getDescription(), HttpStatus.UNAUTHORIZED),

    EMAIL_REQUIRED("EMAIL_REQUIRED", "Required email value", 422, HttpStatusCode.UNPROCESSABLE_ENTITY.getDescription(), HttpStatus.UNPROCESSABLE_ENTITY),

    EMAIL_INVALID("EMAIL_INVALID", "Invalid email", 422, HttpStatusCode.UNPROCESSABLE_ENTITY.getDescription(), HttpStatus.UNPROCESSABLE_ENTITY),

    EMAIL_INCORRECT("EMAIL_INCORRECT", "Incorrect email", 401, HttpStatusCode.UNAUTHORIZED.getDescription(), HttpStatus.UNAUTHORIZED),

    EMAIL_NOT_FOUND("EMAIL_NOT_FOUND", "User with email does not exist", 404, HttpStatusCode.NOT_FOUND.getDescription(), HttpStatus.NOT_FOUND),

    PASSWORD_REQUIRED("PASSWORD_REQUIRED", "Required password value", 422, HttpStatusCode.UNPROCESSABLE_ENTITY.getDescription(), HttpStatus.UNPROCESSABLE_ENTITY),
